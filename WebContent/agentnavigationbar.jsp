            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">  
                        <li class="nav-item">
                            <a class="nav-link js-scroll-trigger" href="AddCustomer.jsp">Register Customer</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link js-scroll-trigger" href="RetrieveCustomerList">Register Item</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link js-scroll-trigger" href="RetrieveRoute">Book Vessel</a>
                        </li>
                        <li class="nav-item">
