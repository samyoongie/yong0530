...
/**
 * Servlet implementation class RetrieveRoute
 */
@WebServlet("/RetrieveRoute")
public class RetrieveRoute extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			request.getRequestDispatcher("RetrieveScheduleList").forward(request, response);
